# Troubleshooting AWS Health identity and access<a name="security_iam_troubleshoot"></a>
...
## I'm not authorized to perform an action in AWS Health<a name="security_iam_troubleshoot-no-permissions"></a>
...
The AWS Health API requires a Business or Enterprise support plan from [AWS Support](http://aws.amazon.com/premiumsupport/)\. If you call the AWS Health API from an account that doesn't have a Business or Enterprise support plan, the following error code is returned: `SubscriptionRequiredException`\.
...
## I'm an administrator and want to allow others to access AWS Health<a name="security_iam_troubleshoot-admin-delegate"></a>
...
## I want to allow people outside of my AWS account to access my AWS Health resources<a name="security_iam_troubleshoot-cross-account-access"></a>
