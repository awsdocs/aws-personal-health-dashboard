# Are You a First\-Time AWS Health User?<a name="first-time-user"></a>

If you are a first\-time user of AWS Health, begin by reading the following sections:
+ What Is AWS Health—This section describes the underlying data model, the operations it supports, and the AWS SDKs that you can use to interact with the service\.
...
For more information about using AWS Health with the AWS CLI, see the [AWS CLI Reference for AWS Health](https://docs.aws.amazon.com/cli/latest/reference/health/index.html)\. For instructions for installing the AWS CLI, see [Installing the AWS Command Line Interface Interface](https://docs.aws.amazon.com/cli/latest/userguide/installing.html)\.